...
export default function PricingPage() {
  ...
  if (loading) {
    return (
      <PageWrapper showFooter={false} className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800">
  ...
  return (
    <PageWrapper showFooter={true} className="min-h-screen bg-gradient-to-br from-purple-600 via-purple-700 to-indigo-800 px-4 py-8">
